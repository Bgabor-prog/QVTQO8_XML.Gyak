...
public class DOMReadQVTQO8 {
    ...
    private static void readKonyv_Onk() {
    ...
    private static void readOnkormanyzat() {
    ...
    private static void readKonyveloIroda() {
    ...
    private static void readUgyfelek() {
